...
function AthleteViewComplaint({ route, navigation }) {
  ...
  const resolveHandler = () => {
    ...
    fetch(`${ip}/updateComplaint/${data._id}`, requestOptions)
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        >
          <TouchableOpacity onPress={resolveHandler} style={styles.button}>
            <Text style={styles.buttonText}>Resolve</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={forwardHandler} style={styles.button}>
